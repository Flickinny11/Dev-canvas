      ...
      >
        <div className="glass rounded-2xl p-8 border border-dark-200">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-dark-400">Sign in to continue building</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-dark-400">
              ...
              <Link href="/auth/signup" className="text-primary-400 hover:text-primary-300 transition-colors">
                Sign up
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-dark-200">
            ...
            <div className="bg-dark-100 rounded-lg p-3 text-xs text-dark-300">
              <p>Email: demo@theexperience.com</p>
